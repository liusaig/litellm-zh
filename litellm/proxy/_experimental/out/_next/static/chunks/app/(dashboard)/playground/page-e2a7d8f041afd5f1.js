(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[8986],{21796:(e,t,i)=>{"use strict";i.d(t,{E:()=>a.A});var a=i(75892)},22603:(e,t,i)=>{"use strict";i.d(t,{Q:()=>o});var a=i(28436);let o=async e=>{try{let t=await (0,a.modelHubCall)(e);if(console.log("model_info:",t),t?.data.length>0){let e=t.data.map(e=>({model_group:e.model_group,mode:e?.mode}));return e.sort((e,t)=>e.model_group.localeCompare(t.model_group)),e}return[]}catch(e){throw console.error("Error fetching model info:",e),e}}},27428:(e,t,i)=>{"use strict";i.d(t,{g:()=>o});var a=i(28436);let o=async e=>{if(!e)return null;try{return await (0,a.getProxyUISettings)(e)}catch(e){return console.error("Error fetching proxy settings:",e),null}}},36690:(e,t,i)=>{"use strict";i.d(t,{sx:()=>n,yz:()=>p});var a,o,r=((a={}).AUDIO_SPEECH="audio_speech",a.AUDIO_TRANSCRIPTION="audio_transcription",a.IMAGE_GENERATION="image_generation",a.VIDEO_GENERATION="video_generation",a.CHAT="chat",a.RESPONSES="responses",a.IMAGE_EDITS="image_edits",a.ANTHROPIC_MESSAGES="anthropic_messages",a.EMBEDDING="embedding",a),n=((o={}).IMAGE="image",o.VIDEO="video",o.CHAT="chat",o.RESPONSES="responses",o.IMAGE_EDITS="image_edits",o.ANTHROPIC_MESSAGES="anthropic_messages",o.EMBEDDINGS="embeddings",o.SPEECH="speech",o.TRANSCRIPTION="transcription",o.A2A_AGENTS="a2a_agents",o.MCP="mcp",o);let s={image_generation:"image",video_generation:"video",chat:"chat",responses:"responses",image_edits:"image_edits",anthropic_messages:"anthropic_messages",audio_speech:"speech",audio_transcription:"transcription",embedding:"embeddings"},p=e=>{if(console.log("getEndpointType:",e),Object.values(r).includes(e)){let t=s[e];return console.log("endpointType:",t),t}return"chat"}},39771:(e,t,i)=>{"use strict";i.d(t,{O:()=>o});var a=i(36690);let o=e=>{let t,{apiKeySource:i,accessToken:o,apiKey:r,inputMessage:n,chatHistory:s,selectedTags:p,selectedVectorStores:l,selectedGuardrails:m,selectedPolicies:u,selectedMCPServers:d,mcpServers:g,mcpServerToolRestrictions:_,selectedVoice:c,endpointType:f,selectedModel:h,selectedSdk:b,proxySettings:y}=e,x="session"===i?o:r,w=window.location.origin,E=y?.LITELLM_UI_API_DOC_BASE_URL;E&&E.trim()?w=E:y?.PROXY_BASE_URL&&(w=y.PROXY_BASE_URL);let I=n||"Your prompt here",v=I.replace(/\\/g,"\\\\").replace(/"/g,'\\"').replace(/\n/g,"\\n"),A=s.filter(e=>!e.isImage).map(({role:e,content:t})=>({role:e,content:t})),S={};p.length>0&&(S.tags=p),l.length>0&&(S.vector_stores=l),m.length>0&&(S.guardrails=m),u.length>0&&(S.policies=u);let $=h||"your-model-name",O="azure"===b?`import openai
...
client = openai.OpenAI(
	api_key="${x||"YOUR_LITELLM_API_KEY"}",
	base_url="${w}"
)`;switch(f){case a.sx.CHAT:{let e=Object.keys(S).length>0,i="";if(e){let e=JSON.stringify({metadata:S},null,2).split("\n").map(e=>" ".repeat(4)+e).join("\n").trim();i=`,
    extra_body=${e}`}let a=A.length>0?A:[{role:"user",content:I}];t=`
import base64
...
`;break}case a.sx.RESPONSES:{let e=Object.keys(S).length>0,i="";if(e){let e=JSON.stringify({metadata:S},null,2).split("\n").map(e=>" ".repeat(4)+e).join("\n").trim();i=`,
    extra_body=${e}`}let a=A.length>0?A:[{role:"user",content:I}];t=`
import base64
